            ...
            <div className="max-w-md mx-auto text-center lg:text-left">
              <header>
                ...
                <p className="mt-4 text-gray-500">
                  Explore our handpicked collection of the season's hottest
                  styles. From elegant watches to trendy accessories, find
                  everything you need to stay fashion-forward.
                </p>
              </header>
            </div>
          </div>
