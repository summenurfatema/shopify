        ...
        <div className="modal-box w-11/12 max-w-3xl bg-white">
          ...
          <div className="grid grid-cols-1  md:grid-cols-2 gap-5 py-2">
            {order?.products?.items?.map((item, itemIndex) => (
              ...
              <div>
                <>
                <h3 class="text-lg font-medium text-gray-800">{item.productTitle}</h3>
                <h3 class="text-lg font-medium text-gray-800">Qnty: {item.quantity}</h3>
                </>
...
//<li
//                className="text-start justify-evenly flex items-center"
//                key={itemIndex}
//              >
//                <img
//                  src={item.productImage}
...
//                />
//
//                <p className="text-center" key={itemIndex}>
//                  {item.productTitle}
//                </p>
//                <p className="text-end" key={itemIndex}>
//                  Qnty: {item.quantity}
//                </p>
//              </li>