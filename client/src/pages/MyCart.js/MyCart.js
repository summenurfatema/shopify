...
// setup quantity of every product
  ...
  //razorpay button "pl_MZpXibRMYJij0x";
  const buttonId = "pl_MZpXibRMYJij0x"
  useEffect(() => {
        ...
        {Array.from({ length: totalPages }, (_, index) => (
          ...
          >
            ...
            <div className="space-y-1 border w-full lg:w-5/12  3xl:w-5/12 p-4 text-right rounded-mdb shadow-lg">
              ...
              <div className="flex flex-col space-y-3 py-2 mb-3">
              ...
              <form id="form" onClick={handleOrders}></form>
            </div>
          </div>
        </div>
      )}
